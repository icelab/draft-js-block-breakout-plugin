...
var defaults = {
  ...
  breakoutBlockTypes: ['header-one', 'header-two', 'header-three', 'header-four', 'header-five', 'header-six']
};
...
function blockBreakoutPlugin() {
  ...
  var defaultBlockType = options.defaultBlockType || defaults.defaultBlockType;
  var breakoutBlockTypes = options.breakoutBlockTypes || defaults.breakoutBlockTypes;
